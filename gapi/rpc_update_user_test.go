...
import (
	...
	mockdb "github.com/AlekseyMoiseenko/simplebank/db/mock"
...
func EqUpdateUserParams(arg db.UpdateUserParams, password string) gomock.Matcher {
	return newPasswordAwareParamsMatcher(
		arg,
		password,
		func(a db.UpdateUserParams) (string, bool) { return a.HashedPassword.String, a.HashedPassword.Valid },
		func(a db.UpdateUserParams) bool { return a.PasswordChangedAt.Valid },
		func(a db.UpdateUserParams) time.Time { return a.PasswordChangedAt.Time },
		func(actual db.UpdateUserParams, expected *db.UpdateUserParams) {
			expected.HashedPassword = actual.HashedPassword
			expected.PasswordChangedAt = actual.PasswordChangedAt
		},
	)
}
