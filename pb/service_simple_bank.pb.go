...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a\x16rpc_verify_email.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\x9f\x04\n" +
	"\n" +
	"SimpleBank\x12|\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"?\x92A\"\x12\x0fCreate new user\x1a\x0fCreate new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12t\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"7\x92A\x1a\x12\vUpdate user\x1a\vUpdate user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\x93\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"Y\x92A=\x12\n" +
	"Login user\x1a/Login user and get access token & refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x86\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"F\x92A+\x12\fVerify email\x1a\x1bVerify user's email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x9f\x01\x92Aq\x12o\n" +
	"\x0fSimple Bank API\"W\n" +
	"\x11Aleksey Moiseenko\x12#https://github.com/AlekseyMoiseenko\x1a\x1daleksey.moiseenko79@gmail.com2\x031.1Z)github.com/AlekseyMoiseenko/simplebank/pbb\x06proto3"
